...
public class Application extends JPanel {
    public static void showEditAccountInfo() {
    ...
    public static void showGroupChat(String username) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
                    APIAccessObject apiAccessObject = new APIAccessObject(ActiveMQConnection.DEFAULT_BROKER_URL);
                ...
                try {
                    ...
                    GroupChatView groupChatView=GroupChatCaseFactory.create(groupChatViewModel,sendMessageInteractor,apiAccessObject);
                    sendMessageInteractor.setOutputBoundary(groupChatView);
